  ...
  <Transition name="input">
    ...
    >
      <div class="input-box" @click.stop>
        ...
        <div class="content">
          <div class="character" @click.stop="setting.select = [false]">
            <img :src="inputData.user.avatar" alt="" class="avatar"/>
        ...
        <div class="btn" :class="{ disabled: !canSubmit }" @click="onBtnClick">{{ btnText }}</div>
      </div>
    </div>
  </Transition>
</template>
