<template>
  <div class="message-box" @contextmenu.prevent="$emit('delete')">
    <div class="del">
    ...
    <div class="content-box">
      <div class="content">
        ...
        <div class="text" v-html="textReplace(message.text, true)"></div>
        <div class="info">
          <div class="icon" :class="{ highlight: message.is_like }">
            <Icon
              width="25"
              height="25"
      ...
      <img class="image" v-if="message.image" :src="message.image" alt=""/>
    </div>
  </div>
</template>
